...
insert into  [Order.Status](Code,[Name]) values
('O1', N'Chờ xác nhận'),
('O2', N'Chờ lấy hàng'),
('O3', N'Đang giao'),
('O4', N'Đã giao'),
...
/*tạo table Cart.Status*/
drop table [Cart.Status];
...
insert into [Cart.Status](Code,[Name]) values
(null,N'Trống'),
(null,N'Có sản phẩm');

/*select * from [Cart.Status]*/
...
insert into [Cart.Item](OrderId,ProductId,Quantity) values
(1,2,4),
(1,3,5),
(2,5,6),
(3,6,7),
