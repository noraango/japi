...
namespace api.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<System.Object> GetComment(int productId)
        {if (_context != null)
            {
                var ratings = await _context.ProductRating.AsQueryable().Where(x => x.ProductId == productId).ToListAsync();
                return ratings;
            }
            return null;
        }
